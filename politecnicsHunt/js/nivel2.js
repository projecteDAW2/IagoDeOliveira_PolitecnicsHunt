...
for (let i = 0; i < numMax; i++) {
  ...
  caja.style.left = Math.floor(Math.random() * window.innerWidth - 200) + "px";
  caja.style.top = Math.floor(Math.random() * window.innerHeight - 200) + "px";
